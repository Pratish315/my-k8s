docker build -t pratish420/multi-clients:latest -t pratish420/multi-clients:$SHA -f ./client/Dockerfile ./client
...
docker push pratish420/multi-clients:latest
docker push pratish420/multi-server:latest
docker push pratish420/multi-worker:latest
docker push pratish420/multi-clients:$SHA
docker push pratish420/multi-server:$SHA
docker push pratish420/multi-worker:$SHA

kubectl apply -f k8s

kubectl set image deployments/client-deployment client=pratish420/multi-clients:$SHA
